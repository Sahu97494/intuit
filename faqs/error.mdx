...
description: Learn how to fix errors in the Intuit Ecosystem API.
---
...
<Note>
You may also see additional Extensions.innerCode and Extensions.innerMessage fields. 
- `Extensions.innerCode` — Internal unique identifier returned by downstream services (Example: PAY-000008 - payroll). 
- `Extensions.innerMessage` — Original internal message from downstream services. 
</Note>
