...
> “At its simplest, GraphQL is about asking for specific fields on objects.” - [GraphQL.org](https://graphql.org)
...
* Visit [GraphQL.org](https://graphql.org/) for a deeper dive
* Check out [courses from edx.org](https://www.edx.org/course/exploring-graphql-a-query-language-for-apis)