...
description: GraphQL is a powerful and efficient API language. Here are a few ways you can structure and craft your code to build world-class apps.
...
<Tip>
Always log the value of the [**intuit_tid** field](https://intuitdeveloper.github.io/intuit-api-docs/docs/faq/error-handling/) in the server response. It will help our support team quickly find and address any reported issues.
</Tip>
